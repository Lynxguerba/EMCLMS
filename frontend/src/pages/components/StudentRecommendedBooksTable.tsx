...
interface StudentRecommendedBooksTableProps {
  courseId: number;
}
...
// Table component
const StudentRecommendedBooksTable: React.FC<
  StudentRecommendedBooksTableProps
> = ({ courseId }) => {
  ...
  useEffect(() => {
    axios
      .get(
        ...
        }/api/student/get/recommended-books/${courseId}/`,
        {
  ...
  if (books.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-gray-400">
        ...
        <p className="text-sm">The instructor hasn't added any books yet</p>
      </div>
    );
  }
  ...
  return (
    <div className="mt-4">
      <p className="text-gray-600 mb-4 text-sm">
        These are the books recommended by the course instructor
      </p>
...
export default StudentRecommendedBooksTable;