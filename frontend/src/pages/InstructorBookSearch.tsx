...
const InstructorBookSearch: React.FC = () => {
 ...
 // Hardcoded page text
 const shortText = "Search for books to recommend to your courses.";
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative group">
                ...
                <div className="relative flex items-center gap-1 bg-white rounded-full shadow-lg border-2 border-gray-200 hover:border-blue-300 focus-within:border-blue-400 transition-all p-2">
                  ...
                  <input
                    type="text"
                    placeholder="Search for books to recommend..."
                    value={searchQuery}
                    ...
                    : "N/A"}
                                ...
                                <div className="flex-shrink-0 flex gap-2">
                                  ...
                                  <button
                                    ...
                                    className="w-10 h-10 rounded-lg bg-blue-500 hover:bg-blue-600 flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-200 group/btn"
                                    title="Recommend to course"
                                  >
                                  ...
                                  {book.file_path && (
                                    <button
                                      ...
                                      className="w-10 h-10 rounded-lg bg-indigo-500 hover:bg-indigo-600 flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-200 group/btn"
                                      title="Download book"
                                    >
