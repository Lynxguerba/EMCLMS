...
// Course type definition for type safety and autocomplete
type Course = {
 course_id: number;
 course_title: string;
 course_code: string;
...
export default function InstructorCourses() {
 ...
 // Update filteredCourses to filter by selectedSchoolYear as well
 ...
 return (
  ...
  >
   {/* Sidebar navigation component - Always rendered */}
   <Sidebar
    userRole={"instructor"}
   ...
   {/* Top navigation bar - Always rendered */}
   ...
   <div className="min-h-screen pt-8 p-4 mt-6 md:-mt-2 md:ml-52">
    ...
    <div className="mb-8">
     ...
     <p className="text-1xl">Manage and view your teaching courses</p>
    </div>
